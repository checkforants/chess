...
const WhiteKing = ({colorNow, setColorNow, figurePositions, squareClicked, setSqureClicked, possibleMoves, setPossibleMoves, fullName,rowName,name,...props}) => {
	...
	return (
		...
		onClick={(e)=>handleClick()}>
			<img {...props} src={require('../whitePieces/King.png')}>
