...
const BlackBishop= ({colorNow, setColorNow, figurePositions,squareClicked, setSqureClicked, possibleMoves, setPossibleMoves, fullName,rowName,name,...props}) => {
	...
	return (
		...
		onClick={(e)=>handleClick()}>
			<img {...props} src={require('../blackPieces/Bishop.png')}>
